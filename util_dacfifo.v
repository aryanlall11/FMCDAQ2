...
module util_dacfifo #(
  ...
  wire    [(DATA_WIDTH-1):0]          dac_data_fifo_s_temp;
  ...
  i_mem_fifo (
    ...
    .reb (1'b1),
    .addrb (dac_raddr),
    .doutb (dac_data_fifo_s_temp));

  assign dac_data_fifo_s = (isFirst == 1'b0) ? 'b0 :
                           (dac_mem_ren_s == 1'b1) ? dac_data_fifo_s_temp : 'b0;
